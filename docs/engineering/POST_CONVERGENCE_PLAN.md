...
- [ ] GitHub Actions CI green on this branch — **deferred 2026-08-19**: no git remote configured; workflows verified by construction only. Revisit when a remote + push access exists.
